...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/CCPD2019_SLPNET.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train_yolov5m6_SLPNet/exp/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='SLPNET', help='save to project/name')
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment')
    parser.add_argument('--half', action='store_true', help='use FP16 half-precision inference')
    opt = parser.parse_args()
    opt.save_json |= opt.data.endswith('CCPD2019_SLPNET.yaml')
